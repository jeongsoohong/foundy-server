...
--
-- Table structure for table `shop_shipping_company`
--
...
CREATE TABLE `shop_shipping_company` (
  ...
  `shipping_company_code` varchar(16) NOT NULL DEFAULT '',
  `shipping_company_name` varchar(64) NOT NULL DEFAULT '',
...
-- Dump completed on 2020-07-30 16:05:38
