...
where b.shop_name= '아로마블리스' and a.shop_id=b.shop_id and a.shipping_status=6 and a.shop_balance=0
...
where shop_id=12 and shipping_status=6 and shop_balance=0 and a.modified_at <= '2021-02-28 23:59:59';