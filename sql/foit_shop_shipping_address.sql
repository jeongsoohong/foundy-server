...
CREATE TABLE `shop_shipping_address` (
  ...
  `phone_1` varchar(16) NOT NULL DEFAULT '',
  `phone_2` varchar(16) NOT NULL DEFAULT '',
  `session_id` varchar(40) NOT NULL,
  `shipping_req` varchar(64) NOT NULL DEFAULT '',
  `shipping_req_code` tinyint(4) NOT NULL DEFAULT '0',
...
-- Dump completed on 2020-07-30 16:05:12
