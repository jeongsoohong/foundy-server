...
|  facebook_login_redirect_url   string   URL tor redirect back to after login. Do not includes domain.
|  facebook_logout_redirect_url  string   URL tor redirect back to after login. Do not includes domain.
