<table border="1" bordercolor="#EAEAEA" class="return-info-table col-md-12">
  <tbody>
  <tr>
    <th class="col-md-2 return-info-header">반송지 정보<span class="required">*</span></th>
    <td class="col-md-10 return-info">
      <div class="col-md-12">
        <div class="col-md-1 return-info-search">
        ...
        <div class="col-md-1 return-info-postcode">
        ...
        <div class="col-md-4 return-info-address-1">
        ...
        <div class="col-md-4 return-info-address-2">
        ...
        <div class="col-md-2 return-info-checkbox">
      ...
      <div class="col-md-12">
        ...
        <div class="col-md-2 return-info-phone" style="text-align: left">
  ...
  <tr>
    <th class="col-md-2 return-price-info-header">교환/반품 정책<span class="required">*</span></th>
    <td class="col-md-10 return-policy">
      <div class="col-md-6 return-policy-price">
      ...
      <div class="col-md-6 return-policy-ship-price">
        <div class="col-md-7" style="text-align: right">
          배송택배비
        </div>
        <div class="col-md-4">
