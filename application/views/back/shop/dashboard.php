          ...
          <div class="panel-body">
            <div class="text-center">
              <table class="col-md-12">
                <thead>
                <tr>
                  <th class="col-md-2">입금대기</th>
                  <th class="col-md-2">결제완료</th>
                  <th class="col-md-2">상품준비중</th>
                  <th class="col-md-2">배송중</th>
                  <th class="col-md-2">배송완료</th>
                </tr>
                </thead>
                <tbody>
                <tr>
          ...
          <div class="panel-body">
            <div class="text-center">
              <table class="col-md-12">
                <thead>
                <tr>
                  <th class="col-md-6">발송지연</th>
                  <th class="col-md-6">반품접수</th>
                </tr>
                </thead>
                <tbody>
                <tr>
    ...
    <div class="row">
      <div class="col-md-8">
        <div class="panel panel-bordered panel-dark">
          ...
          <div class="panel-body">
            <div class="text-center">
              <table class="col-md-12" border="1" bordercolor="grey">
                <thead>
          ...
          <div class="panel-body">
            <div class="text-center">
              <table class="col-md-12">
                <thead>
                <tr>
                  <th class="col-md-12">6월 정산 확정금액</th>
                </tr>
                </thead>
                <tbody>
                <tr>
                  <td class="col-md-12">000,000원</td>
                </tr>
                </tbody>
              </table>
            </div>
