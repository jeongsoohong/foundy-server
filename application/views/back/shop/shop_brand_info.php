...
<table border="1" bordercolor="#EAEAEA" class="col-md-12 col-sm-12 col-xs-12">
  <tbody>
<!--  <tr>-->
<!--    <th class="col-md-2 col-sm-2 col-xs-2 brand-text-date-header" style="background-color: #EAEAEA">브랜드 기간 문구</th>-->
<!--    <td class="col-md-10 col-sm-10 col-xs-10 brand-text-date">-->
...
<!--        </div>-->
<!--      </div>-->
<!--      <div class="col-md-12 col-sm-12 col-xs-12" style="color: saddlebrown">-->
<!--        * 기간설정 코멘트는 아래의 브랜드 코멘트보다 상위에 노출됩니다.-->
<!--      </div>-->
<!--    </td>-->
<!--  </tr>-->
  <tr>
    <th class="col-md-2 col-sm-2 col-xs-2 brand-text-base-header" style="background-color: #EAEAEA">브랜드 문구</th>
    <td class="col-md-10 col-sm-10 col-xs-10 brand-text-base">
      <div class="col-md-12 col-sm-12 col-xs-12">
