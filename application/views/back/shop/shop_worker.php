<table class="col-md-12 col-sm-12 col-xs-12">
  <thead>
  <tr>
    <th class="col-md-1 col-sm-1 col-xs-1">담당</th>
    <th class="col-md-2 col-sm-2 col-xs-2">담당자</th>
    <th class="col-md-2 col-sm-2 col-xs-2">전화번호</th>
    <th class="col-md-2 col-sm-2 col-xs-2">핸드폰번호</th>
    <th class="col-md-3 col-sm-3 col-xs-3">이메일</th>
    <th class="col-md-2 col-sm-2 col-xs-2">추가/삭제/수정</th>
  </tr>
  </thead>
  <tbody>
