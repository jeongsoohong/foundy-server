<table class="shipping-info-table col-md-12" border="1" bordercolor="#EAEAEA">
  <tbody>
  <tr>
    <th class="col-md-2 send-info-header">발송지 정보<span class="required">*</span></th>
    <td class="col-md-10 send-info">
      <div class="col-md-12">
        <div class="col-md-1 send-info-postcode-search">
        ...
        <div class="col-md-1 send-info-postcode">
        ...
        <div class="col-md-4 send-info-address-1">
        ...
        <div class="col-md-4 send-info-address-2">
        ...
        <div class="col-md-2 send-info-checkbox">
      ...
      <div class="col-md-12">
        ...
        <div class="col-md-2 send-info-phone" style="text-align: left">
  ...
  <tr>
    <th class="col-md-2 shipping-info-header">배송지 정책<span class="required">*</span></th>
    <td class="col-md-10 shipping-info">
      <div class="col-md-12">
        <div class="col-md-6 shipping-info-checkbox" style="text-align: right">
      ...
      <div class="col-md-12">
        <div class="col-md-6 shipping-info-total-price">
        ...
        <div class="col-md-6 shipping-info-cond-price">
          <div class="col-md-7" style="text-align: right">
            미만 구매시 배송비
          </div>
          <div class="col-md-4">
  ...
  <tr>
    <th class="col-md-2 shipping-company-header">출고 택배사 관리<span class="required">*</span></th>
    <td class="col-md-10 shipping-company">
      <div class="col-md-12">
        <div class="col-md-4">
          택배사 전체리스트
        </div>
      ...
      <div class="col-md-12 shipping-company-info">
        <div class="col-md-4 shipping-company-left">
          <!-- loading -->
        </div>
        <div class="col-md-1">
        ...
        <div class="col-md-4 shipping-company-right">
...
<script>
  ...
  function get_shipping_company() {
    $.ajax({
      url: 'https://info.sweettracker.co.kr/api/v1/companylist?t_key=OiMqBmE0a9g8ibCUoY8yng',
