<div class="cnt--tit">
  <p class="tit-case"><span id="cancel-all"><?= ($no_cancel_info->total_balance - $no_cancel_info->total_discount) == 0 ? '전체' : '부분'; ?></span>취소</p>
</div>
<div class="cnt--table">
...
<button class="cnt--cancel-confirm" onclick="do_cancel()"><?= ($no_cancel_info->total_balance - $no_cancel_info->total_discount) == 0 ? '전체' : '부분'; ?> 결제 금액 취소</button>
