<div id="content-container">
    <div id="page-title">
        <h1 class="page-header text-overflow" >Manage Blog Category</h1>
    </div>
    <div class="tab-base">
        <div class="panel">
                ...
                <div class="tab-content">
                    <div style="border-bottom: 1px solid #ebebeb;padding: 25px 5px 5px 5px;"
                        ...
                        <button class="btn btn-primary btn-labeled fa fa-plus-circle pull-right mar-rgt"
                                onclick="ajax_modal('add','<?php echo ('add_blog_category'); ?>','<?php echo ('successfully_added!'); ?>','blog_category_add','')">
                            추가
                        </button>
                    </div>
                    <br>
