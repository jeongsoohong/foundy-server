      ...
      <tr>
        ...
        <td class="text-right">
          <a class="btn btn-dark btn-xs btn-labeled fa fa-user" data-toggle="tooltip"
             ...
             ?>','center_view','<?php echo $row['studio_id']; ?>')" data-original-title="View"
             data-container="body">
            프로필
          </a>
          <a class="btn btn-warning btn-xs btn-labeled fa fa-check"
             data-toggle="tooltip" onclick="ajax_modal('approval','studio_approval','successfully activate',
            'studio_approval','<?php echo $row['studio_id']; ?>')" data-original-title="View" data-container="body">
            상태변경
          </a>
          <a onclick="delete_confirm('<?php echo $row['studio_id']; ?>','정말 삭제하시겠습니까?')"
