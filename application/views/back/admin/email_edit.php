<div class="row">
  <div class="col-md-12">
    <?php
    echo form_open(base_url() . 'admin/email/update/'.$email->email_id, array(
        ...
        <div class="tab-content">
          <div id="blog_details" class="tab-pane fade active in">
            ...
            <div class="form-group btm_border">
              ...
              <div class="col-sm-6">
                <?php echo $this->crud_model->select_html('category_email','type','desc','edit','demo-chosen-select required',$email->type,'','',''); ?>
              </div>
            </div>
            <div class="form-group btm_border">
              ...
              <div class="col-sm-6">
                <input type="text" name="subject" id="demo-hor-1" placeholder="제목을 입력해주세요"
                       class="form-control required" value="<?php echo $email->subject; ?>">
              </div>
            </div>
            <div class="form-group btm_border">
              <label class="col-sm-4 control-label" for="demo-hor-1">보내는 주소</label>
              <div class="col-sm-6">
                <input type="text" name="from" id="demo-hor-1" placeholder="보내는 이메일 주소(hello@foundy.me)"
                       class="form-control required" value="<?php echo $email->from; ?>">
              </div>
            </div>
            <div class="form-group btm_border">
              ...
              <div class="col-sm-6">
                <input type="text" name="from_name" id="demo-hor-1" placeholder="보내는 사람(FOUNDY)"
                       class="form-control required" value="<?php echo $email->from_name; ?>">
              </div>
            </div>
            <div class="form-group btm_border">
              <label class="col-sm-4 control-label" for="demo-hor-1">메일 타입</label>
              <div class="col-sm-6">
                <input type="text" name="mailtype" id="demo-hor-1" placeholder="html"
                       class="form-control required" value="<?php echo $email->mailtype; ?>">
              </div>
            </div>
            <div class="form-group btm_border">
              ...
              <div class="col-sm-6">
                <input type="text" name="substitute_str" id="demo-hor-1" placeholder="{{EMAIL}}, {{PW}}, {{BRAND}} 등"
                       class="form-control" value="<?php echo $email->substitute_str; ?>">
              </div>
            </div>
            <div class="form-group btm_border">
              <label class="col-sm-4 control-label" for="demo-hor-13">이메일 본문</label>
              <div class="col-sm-6">
                <textarea rows="9"  class="summernotes" id='summernotes' data-height="300" data-name="email_body"><?php echo $email->email_body; ?></textarea>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-11">
            <span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right"
                  onclick="ajax_set_full('edit','edit_email','정상적으로 리셋되었습니다!','email_edit','<?php echo $email->email_id; ?>') ">
              <?php echo ('리셋');?>
            </span>
        </div>
        <div class="col-md-1">
          <span class="btn btn-success btn-md btn-labeled fa fa-upload pull-right enterer"
                onclick="form_submit('email_edit','정상적으로 업로드되었습니다!');proceed('to_edit');" >업로드</span>
        </div>
      </div>
    </div>
    </form>
...
<script type="text/javascript">
  ...
  function sendFile(file,editor,welEditable) {
    ...
    $.ajax({
      url: "<?php echo base_url() . 'admin/email/upload_image/'.$email->email_id; ?>",
      data: data,
      cache: false,
      contentType: false,
      enctype: 'multipart/form-data',
