...
foreach($shop_data as $row){
  ...
  <div class="row">
    <div class="col-md-12">
      <?php
      echo form_open(base_url() . 'admin/shop/update/' . $row['shop_id'], array(
      ...
      <div class="panel-body">
        <div id="shop_details" class="tab-pane fade active in">
          <div class="form-group btm_border">
            ...
            <div class="col-sm-6">
              <input type="text" name="shop_name" id="demo-hor-1" value="<?php echo $row['shop_name']; ?>" placeholder="상호명" class="form-control required">
            </div>
          </div>
          <div class="form-group btm_border">
            ...
            <div class="col-sm-6">
              <input type="text" name="representative_name" id="demo-hor-2" placeholder="대표자명" class="form-control required" value="<?php echo $row['representative_name']; ?>">
            </div>
          </div>
          <div class="form-group btm_border">
            ...
            <div class="col-sm-6">
              <input type="text" name="shop_phone" id="demo-hor-3" placeholder="연락처" class="form-control required" value="<?php echo $row['shop_phone']; ?>">
            </div>
          </div>
          <div class="form-group btm_border">
          ...
          <div class="form-group btm_border">
            ...
            <div class="col-sm-6">
              <input type="text" name="shop_items" id="demo-hor-4" placeholder="푹목" class="form-control required" value="<?php echo $row['shop_items']; ?>">
            </div>
          </div>
          <div class="form-group btm_border">
            ...
            <div class="col-sm-6">
              <input type="url" name="shop_homepage_url" id="demo-hor-5" placeholder="홈페이지" class="form-control required" value="<?php echo $row['shop_homepage_url']; ?>">
            </div>
          </div>
          <div class="form-group btm_border">
            ...
            <div class="col-sm-6">
              <input type="email" name="email" id="demo-hor-6" placeholder="이메일" class="form-control required" value="<?php echo $row['email']; ?>">
            </div>
          </div>
          <div class="form-group btm_border">
            ...
            <div class="col-sm-6">
              <input type="text" name="business_license_num" id="demo-hor-7" placeholder="사업자등록번호" class="form-control" value="<?php echo $row['business_license_num']; ?>">
            </div>
          </div>
          <div class="form-group btm_border">
            ...
            <div class="col-sm-6">
              <input type="text" name="business_conditions" id="demo-hor-8" placeholder="업종" class="form-control" value="<?php echo $row['business_conditions']; ?>">
            </div>
          </div>
          <div class="form-group btm_border">
            ...
            <div class="col-sm-6">
              <input type="text" name="business_type" id="demo-hor-9" placeholder="업태" class="form-control" value="<?php echo $row['business_type']; ?>">
            </div>
          </div>
          <div class="form-group btm_border">
          ...
          <div class="form-group btm_border">
            ...
            <div class="col-sm-6">
              <input type="url" name="sns_url" id="demo-hor-11" placeholder="인스타그램 / 페이스북" class="form-control" value="<?php echo $row['sns_url']; ?>">
            </div>
          </div>
          <div class="form-group btm_border">
            ...
            <div class="col-sm-6">
              <input readonly type="text" name="register_at" id="demo-hor-12" placeholder="등록일" class="form-control required" value="<?php echo $row['register_at']; ?>">
            </div>
          </div>
          <div class="form-group btm_border">
            ...
            <div class="col-sm-6">
              <input type="text" name="bank_name" id="demo-hor-13" placeholder="은행" class="form-control" value="<?php echo $row['bank_name']; ?>">
            </div>
          </div>
          <div class="form-group btm_border">
            ...
            <div class="col-sm-6">
              <input type="text" name="bank_account_num" id="demo-hor-14" placeholder="계좌번호" class="form-control" value="<?php echo $row['bank_account_num']; ?>">
            </div>
          </div>
          <div class="form-group btm_border">
            ...
            <div class="col-sm-6">
              <input type="text" name="bank_depositor" id="demo-hor-15" placeholder="예금주" class="form-control" value="<?php echo $row['bank_depositor']; ?>">
            </div>
          </div>
          <div class="form-group btm_border">
        ...
        <div class="row">
          <div class="col-md-11">
            <span class="btn btn-purple btn-labeled fa fa-refresh pro_list_btn pull-right"
                  onclick="ajax_set_full('edit','edit_shop','정상적으로 리셋되었습니다!','shop_edit','<?php echo $row['shop_id']; ?>')">
              리셋
            </span>
          </div>
          <div class="col-md-1">
            <span class="btn btn-success btn-md btn-labeled fa fa-wrench pull-right enterer" onclick="form_submit('shop_edit','정상적으로 수정되었습니다!');proceed('to_add');" >
              수정
            </span>
          </div>
        </div>
