...
<!--  <link href="--><?php //echo base_url(); ?><!--template/back/css/activeit.min.css" rel="stylesheet">-->
  <link rel="stylesheet" href="<?php echo base_url().'template/back/center/admin.css?v=1.1.1'; ?>">
...
<!--  <script src="--><?php //echo base_url().'template/back/center/jquery.js'; ?><!--"></script>-->
