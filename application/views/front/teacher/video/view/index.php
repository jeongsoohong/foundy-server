<section class="page-section with-sidebar">
    <div class="container">
        <div class="row">
            ...
            <!-- CONTENT -->
            <?php
            if (strncmp($video_data->video_url, 'http', 4) && strncmp($video_data->video_url, '//', 2)) {
                $video_data->video_url = '//'.$video_data->video_url;
            }
            ?>
...
<!--                                <img src="--><?php //echo base_url(); ?><!--uploads/icon/heart icon_do.png" style="width:15px !important; height: 15px !important;"> &nbsp 0-->
<!--                            </span>-->
...
<!--                                <img src="--><?php //echo base_url(); ?><!--uploads/icon/scrap icon_do.png" style="width:15px !important; height: 15px !important;">-->
<!--                            </span>-->
                    </div>
                    <!--            <div class="buttons">
                                    <div id="share"></div>
