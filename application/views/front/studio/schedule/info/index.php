          ...
          <div class="card_class">
            <div class="class_box">
              ...
              <span class="font-futura day_morning">
                <?= $this->studio_model->get_ampm($schedule->start_time); ?>
              </span>
                <span class="font-futura time_start">
                <?= $this->studio_model->get_time($schedule->start_time); ?>
              </span>
                <br>~
                <span class="font-futura day_afternoon">
                <?= $this->studio_model->get_ampm($schedule->end_time); ?>
              </span>
                <span class="font-futura time_end">
                <?= $this->studio_model->get_time($schedule->end_time); ?>
              </span>
              </p>
              ...
              <? if ($schedule->reserve_info->reserve) { ?>
                <button class="type_btn btn_off" onclick="open_link_popup(<?= $schedule->schedule_info_id; ?>)">
                  <? if (isset($schedule->class_link) && empty($schedule->class_link) == false) { ?>
              ...
              <? } else { ?>
                <button class="type_btn btn_off" onclick="open_wait_popup(<?= $schedule->schedule_info_id; ?>)">
...
<!--            --><?// } ?>
        ...
        <? } else if($schedule->ticketing) { ?>
          ...
          <div class="card_class">
            ...
            <button class="type_btn btn_on" onclick="open_reserve_popup_online(<?= $schedule->schedule_info_id; ?>)">
