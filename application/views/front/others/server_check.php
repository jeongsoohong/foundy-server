...
<div style="height: inherit; box-sizing: border-box; margin: 0; min-width: 320px; position: relative; background-color: #845b4c;">
  <div style="font-size: 0; text-align: center; width: 240px; height: 184px; position: absolute; top: 40%; left: 50%; margin-top: -92px; margin-left: -120px;">
    <div>
      ...
      <p style="margin: 28px 0 0 0; color: #fff; font-size: 16px; font-weight: normal; line-height: 1.65; text-align: center;">서버 점검중 입니다!
        <br>잠시 후 다시 접속해주세요.</p>
    </div>
<!--    <a href="#" style="display: block; text-decoration: none; font-family: 'futura-pt' !important; background-color: #fff; box-sizing: border-box; padding: 0 16px; color: #111; box-shadow: 0 4px 8px 0 rgba(0,0,0,0.3); font-size: 16px; font-weight: normal; height: 56px; line-height: 56px; border-radius: 28px; margin: 24px auto 0;">BACK TO HOME</a>-->
  </div>
</div>
