...
defined('SERVER_EMAIL_TYPE_USER_QNA_RES') OR define('SERVER_EMAIL_TYPE_USER_QNA_RES', 7);
defined('SERVER_EMAIL_TYPE_USER_APPROVAL') OR define('SERVER_EMAIL_TYPE_USER_APPROVAL', 8);
defined('SERVER_EMAIL_TYPE_SHOP_SHIPPING_STATUS') OR define('SERVER_EMAIL_TYPE_SHOP_SHIPPING_STATUS', 9);
defined('SERVER_EMAIL_TYPE_USER_SHIPPING_STATUS') OR define('SERVER_EMAIL_TYPE_USER_SHIPPING_STATUS', 10);
defined('SERVER_EMAIL_TYPE_USER_QNA_REQ') OR define('SERVER_EMAIL_TYPE_USER_QNA_REQ', 11);
...
defined('CENTER_TICKET_MEMBER_ACTION_MODIFY')          OR define('CENTER_TICKET_MEMBER_ACTION_MODIFY', 9);
